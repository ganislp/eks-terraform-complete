...
resource "kubernetes_service_v1" "myapp3_nlb_service" {
  metadata {
    ...
    annotations = {
      # Traffic Routing
      "service.beta.kubernetes.io/aws-load-balancer-name"            = "xtdns-tls-lbc-network-lb"
      ...
      "external-dns.alpha.kubernetes.io/hostname" = "tfnlbdns101.skywaytechsolutions.com"
    }
  }
  spec {
    selector = {
